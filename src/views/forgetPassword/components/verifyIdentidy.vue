      ...
      <ul class="form">
        <li>
          ...
          <el-form-item prop="new_phone">
            <el-input v-model="ruleForm.new_phone" size="small" placeholder="请输入手机号码" />
          </el-form-item>
        </li>
        <el-form-item prop="code">
          <li>
            <span class="lable">验证码:</span>
            <el-input v-model="ruleForm.code" class="i_item" size="small" placeholder="验证码" />
            <el-button
              :loading="loading"
              size="small"
              class="get_code"
...
export default {
  ...
  watch: {
    ruleForm: {
      handler(newVal) {
        this.$emit('update:phone', newVal.new_phone)
      },
      deep: true
    }
  },
